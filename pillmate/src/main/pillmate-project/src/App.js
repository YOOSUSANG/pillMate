...
import NearbyPharmacy from "./page/NearbyPharmacy";
...
export const PillMateLoginStateContext = React.createContext()
export const pillHandlerContext = React.createContext()
export const pillDetailsContext = React.createContext()
                    ...
                    <BrowserRouter>
                        <div className="App">
                            <Routes>
                                ...
                                <Route path={"/map"} element={<NearbyPharmacy></NearbyPharmacy>}></Route>
                            </Routes>
                        </div>
                    </BrowserRouter>
